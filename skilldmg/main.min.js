...
function fillSkills(){var c=document.getElementById("skills");c.innerHTML="";for(var b in fSkills){var a=fSkills[b],d=document.createElement("option");d.setAttributes("value",a.Id,"name",b);d.innerText=b;"0"==a.Id&&d.setAttribute("selected","");c.appendChild(d)}}function handleSkOpt(c){fSkills&&lastSkill!=c.target.value&&(lastSkill=c.target.value,doSkillCalc(c.target.value,!0))}
