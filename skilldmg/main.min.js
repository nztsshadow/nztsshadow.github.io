...
$jscomp.makeIterator=function(c){var b="undefined"!=typeof Symbol&&Symbol.iterator&&c[Symbol.iterator];if(b)return b.call(c);if("number"==typeof c.length)return $jscomp.arrayIterator(c);throw Error(String(c)+" is not an iterable or ArrayLike");};window.onload=initialize;var fSkills,lastSkill;HTMLElement.prototype.setAttributes=function(){if(0<arguments.length&&0==arguments.length%2)for(var c=0;arguments.length>c;c+=2)this.setAttribute(arguments[c],arguments[c+1])};
...
function fillSkills(){var c=document.getElementById("skills");c.innerHTML="";for(var b in fSkills){var a=fSkills[b],d=document.createElement("option");d.setAttributes("value",a.Id,"name",b);d.innerText=b;d.addEventListener("click",handleSkOpt.bind(d),!1);"0"==a.Id&&d.setAttribute("selected","");c.appendChild(d)}}function handleSkOpt(c){fSkills&&lastSkill!=c.target.value&&(lastSkill=c.target.value,doSkillCalc(c.target.value,!0))}
function handleCNInp(c){fSkills&&/^-?(0|[1-9]\d*)(\.\d+)?$/.test(c.target.value)&&doSkillCalc(document.getElementById("skills").value,!1)}function handleCInp(c){fSkills&&doSkillCalc(document.getElementById("skills").value,!1)}
...
function initialize(){document.getElementById("skillsf").addEventListener("change",handleTxt,!1);document.getElementById("skills").addEventListener("mouseup",handleSkOpt,!1);document.getElementById("sklvl").addEventListener("keyup",handleCNInp,!1);document.getElementById("syndmg").addEventListener("keyup",handleCNInp,!1);document.getElementById("dtypes").addEventListener("mouseup",handleCInp,!1);document.getElementById("mind").addEventListener("keyup",handleCNInp,!1);document.getElementById("midlv1").addEventListener("keyup",
handleCNInp,!1);document.getElementById("midlv2").addEventListener("keyup",handleCNInp,!1);document.getElementById("midlv3").addEventListener("keyup",handleCNInp,!1);document.getElementById("midlv4").addEventListener("keyup",handleCNInp,!1);document.getElementById("midlv5").addEventListener("keyup",handleCNInp,!1);document.getElementById("maxd").addEventListener("keyup",handleCNInp,!1);document.getElementById("madlv1").addEventListener("keyup",handleCNInp,!1);document.getElementById("madlv2").addEventListener("keyup",
handleCNInp,!1);document.getElementById("madlv3").addEventListener("keyup",handleCNInp,!1);document.getElementById("madlv4").addEventListener("keyup",handleCNInp,!1);document.getElementById("madlv5").addEventListener("keyup",handleCNInp,!1);document.getElementById("dlen").addEventListener("keyup",handleCNInp,!1);document.getElementById("lenlv1").addEventListener("keyup",handleCNInp,!1);document.getElementById("lenlv2").addEventListener("keyup",handleCNInp,!1);document.getElementById("lenlv3").addEventListener("keyup",
handleCNInp,!1)};
